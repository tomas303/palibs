unit rtti_idebinder_uGridBinders;
...
uses
  Classes, SysUtils, Grids, rtti_idebinder_uBinders, controls, LCLProc, LCLType,
  lmessages, StdCtrls, MaskEdit, rtti_broker_iBroker;
...
type
  ...
  public
    destructor Destroy; override;
    procedure Bind(AGrid: TCustomDrawGrid; AGridData: IGridData; ADataQuery: IRBDataQuery);
...
procedure TGridBinder.Bind(AGrid: TCustomDrawGrid; AGridData: IGridData; ADataQuery: IRBDataQuery);
var
  mData: IRBData;
  i: integer;
begin
